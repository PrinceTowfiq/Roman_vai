              ...
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4"  action="" method="POST">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="radio" id="form3Example4cd"  name="gender" value="Male" />
                      <label class="form-label" for="form3Example4cd">Male</label>
                    </div>
                    <div class="form-outline flex-fill mb-0">
                      <input type="radio" id="form3Example4cd"  name="gender" value="Female" />
                      <label class="form-label" for="form3Example4cd">Female</label>
                    </div>
                  </div>
